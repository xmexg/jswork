            ...
            goodsList: [
                ...
                },
                {
                    ...
                    "evaluation": [
                        {
                            "star": 5,
                            "content": "树莓派做工很好，质量过关，性能杠杠的，接口也丰富，是一款非常好用的单片机，同时也具有很好的计算性能和嵌入式开发优势，对于开发，是一种很好的通用选择"
                        },
                        {
                            "star": 5,
                            "content": "树莓派是非常好的单片机，同时具有很好的计算性能和嵌入式开发优势，对于现在的开发，树莓派是一个很好的通用选择。价格也比较合适"
                        },
                        {
                            "star": 5,
                            "content": "东西很好，以前搞过之前版本的树莓派，现在的整体性能提高了不少，赶紧再更新一下，套装里面对于物联网的东西还是很齐全的，可以折腾好一段时间了，卖家也很周到，包装还有发的教材什么的，都很全面，需要花点时间搞起来！"
                        },
                        {
                            "star": 1,
                        ...
                        {
                            "star": 1,
                            "content": "我习惯在京东买东西，一是京东快递速度，另外一个就是售后服务，你这是**过来的吧，客服态度垃圾的很！有问题就跟你扯皮"
                        },
                        {
                            "star": 1,
                            "content": "4B的用户还是买官方的吧 这个虽然也能用 但是兼容性不高 可用监测是0 opencv拉不起来视频 只能用用libcamera"
                        },
                        {
                            "star": 1,
                            "content": "摄像头检测不到，技术人员直接摆烂，他的教程是raspistill，新版本系统是libcamera不支持raspistill了，他让我安装老系统直接说不会。直接不管你爱买不买，要不退回来吧。呼和浩特目前疫情静默，退也退不回去，只能看着吃哑巴亏。"
                        }
                    ]
                },
                {
                    ...
                    "evaluation": [
                        {
                            "star": 5,
                            "content": "产品很好用，功能强大，是我想要的，老板还给了教程，没想到，出奇的好用"
                        },
                        {
                            "star": 5,
                            "content": "原先我是觉得这么低的价格买到的东西能正常使用吗，结果发现确实如描述所说免驱而且能进入Monitor模式。不过因为没有天线所以接收信号的能力不强，基本就和手机差不多水平。另外也不支持wifi中5g的那些频道。总之如果只是用来做实验的话完全是值得推荐使用的。"
                        },
                        {
                            "star": 5,
                            "content": "我买的这个rt3070就够用了，确实好用，实验可以做出来，mua的，你做出来你就知道，原来这个b站这个教程就是教你跑字典，不在字典里面的密码你根本破解不出来，不过这个网卡抓包确实快，nb。网卡是nb的，b站教程教的像是原始人"
                        },
                        {
                            "star": 5,
                            "content": "完全没问题，完全支持kali，自己按照教程来非常轻松就把实验用的wifi破解了"
                        },
                        {
                            "star": 5,
                            "content": "挺方便，openSUSE Leap 15.4插上就能识别。看一下模块名字是rt2800usb 信号还可以，AP模式我还没试，不过暂时先用着了"
                        },
                        {
                            "star": 5,
                        ...
                        {
                            "star": 3,
                            "content": "就学习抓包用，玩玩还可以，当网卡是真当不了。信号超级弱，我坏的笔记本内置网卡都比这个强。所以pin是不可能的，太弱了信号"
                        },
                        {
                            "star": 1,
                            "content": "我只能说很垃圾哦 避雷 连wifi握手包都抓不到 客户端mac地址都抓不了😆 试了很久"
                        },
                        {
                            "star": 5,
                            "content": "使用简单方便，可以搜到一些平时搜索不到的ssid，结合kali可以实现wi-fi爆破测试"
                        }
                    ]
                },
                {
                    ...
                    "evaluation": [
                        ...
                        {
                            "star": 5,
                            "content": "我自己用学信网和学生证的资料申请直接被机器人秒拒，这边几分钟就激活了连资料都不用……真不知道github的机器人有多zz，希望不会封号，翻车了就来追评"
                        },
                        {
                            "star": 5,
                            "content": "有一说一 服务不错 至少我问了半小时 逐一给了解答 确实辛苦卖家了。目前成功激活了**和copilot，卖家承诺如果后续有问题会解决，至少开始服务很棒。"
                        },
                        {
                            "star": 5,
                            "content": "这个三分钟就好了，看教程自己申请得几天，价格真的很划算了"
                        },
                        {
                            "star": 5,
                        ...
                        {
                            "star": 5,
                            "content": "登陆成功，主要用copilot就看账号的稳定性如何了，还有店家的售后"
                        },
                        {
                            "star": 5,
                        ...
                        {
                            "star": 5,
                            "content": "卖家发货快，耐心教导使用教程，还提供视频教程，vscode、idea都安装好copilot并且都能使用，非常满意！"
                        }
                    ]
                },
                {
